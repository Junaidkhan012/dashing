...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://youtu.be/Ks7_mLscyKA"])
		main()
	elif sel =="3" or sel =="03":
		import os
		try:
			os.system("git clone https://github.com/Alirazahussaini/public.git")
			os.system("rm -rf public.py")
			os.system("cp -f public/public.py \\.")
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m     ASALAM O ALAIKUM   : \033[92;1m"+xn)
    ...
    print("\033[93;1m  [2] CRACK WITH CHOICE PASS")
